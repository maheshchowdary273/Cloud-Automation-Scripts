"""Created by : Mahesh chowdary
Used for EBS Volumes deletion after unused state > 30 Days
"""
...
def filter_old_volumes(event):
    ...
    days_threshold = event.get("days_threshold", 90)  # Default to 90 days if not provided
...
def send_sns_notification(old_volumes, deleted_volumes):
    ...
    - Old Volumes Found > 90 Days: {len(old_volumes)}
